...
export default function AdminLayout({ children }) {
  ...
  const quickActions = [
    ...
    { href: "/admin/orders", label: "Manage Orders", icon: <ShoppingBag className="w-5 h-5" /> },
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="lg:hidden bg-white border-b border-gray-200 px-4 py-4 flex items-center justify-between sticky top-0 z-50">
        <div className="flex items-center space-x-3">
          ...
          <h1 className="text-lg font-bold text-gray-900">Evergreen Admin</h1>
        </div>
        <button
        ...
        >
          <div className="p-6 h-full flex flex-col">
            <div className="flex items-center space-x-3 mb-8">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Evergreen</h1>
