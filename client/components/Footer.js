        ...
        <div className="bg-gradient-to-r from-primary/20 to-secondary/20 border-b border-gray-700">
          <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-8 md:py-12">
            <div className="max-w-2xl mx-auto text-center">
              ...
              >
                <div>
                  <h3 className="text-[10px] sm:text-xl md:text-4xl font-bold mb-1 sm:mb-4 bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
                    Stay Connected with Nature
                  </h3>
                  <p className="text-gray-300 text-[8px] sm:text-sm md:text-lg">
                ...
                <form
                  ...
                  className="flex flex-col sm:flex-row gap-1 sm:gap-3 max-w-lg mx-auto"
                >
                  <input
                    type="email"
                    ...
                    className="flex-1 px-2 sm:px-5 py-1 sm:py-4 rounded-lg text-gray-900 text-[8px] sm:text-sm focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-gray-900 transition-all"
                    required
                  />
                  <motion.button
                    type="submit"
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="btn-primary whitespace-nowrap px-2 sm:px-8 py-1 sm:py-4 text-[8px] sm:text-sm font-semibold disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                  >
